...
CONFIG_FILE="config/experiments/traceableformer/orthogonal_attention/roberta_mlm_orthogonal_o1.yaml"
WANDB_API_KEY="0002c6b12094cc0806f5d415088555cc552ca961"
GPU_COUNT="4"
MEMORY="32G"
TIME_LIMIT="24:00:00"
PARTITION="dgx"
JOB_NAME="roberta_mlm_orthogonal_o1"
CPUS_PER_TASK="1"
NODES="1"
NTASKS_PER_NODE="1"
OUTPUT_DIR="roberta_mlm_orthogonal_o1"
OUTPUT_FILE_PATTERN="%j_roberta_mlm_orthogonal_o1.out"
ERROR_FILE_PATTERN="%j_roberta_mlm_orthogonal_o1.err"
DRY_RUN=false
FORCE_REBUILD=false
